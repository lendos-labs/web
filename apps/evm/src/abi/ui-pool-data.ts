    ...
    outputs: [
      {
        ...
        internalType: 'struct IUiPoolDataProviderV4.AggregatedReserveData[]',
        name: '',
        type: 'tuple[]',
      },
      {
        ...
        internalType: 'struct IUiPoolDataProviderV4.BaseCurrencyInfo',
        name: '',
        type: 'tuple',
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType: 'struct IUiPoolDataProviderV4.UserReserveData[]',
        name: '',
        type: 'tuple[]',
      },
      {
...
export const uiPoolDataNeonDevnetAbi = [
  {
    inputs: [
      {
        internalType: 'contract IEACAggregatorProxy',
...
export const getUiPoolDataAbi = (market: SupportedMarkets) => {
  switch (market) {
    case SupportedMarkets.neon_devnet:
      return uiPoolDataNeonDevnetAbi;
    case SupportedMarkets.neon:
      return uiPoolDataNeonAbi;
    case SupportedMarkets.hemi:
    case SupportedMarkets.sepolia:
    case SupportedMarkets.hemi_testnet:
      return uiPoolDataAbi;
    default:
      return uiPoolDataAbi;
  }
};
